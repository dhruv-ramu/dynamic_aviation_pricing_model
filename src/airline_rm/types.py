...
class SimulationConfig:
    ...
    dynamic_weight_demand_pressure: float = 1.62
    dynamic_score_strong_raise: float = 1.02
    dynamic_score_mild_raise: float = 0.24
    dynamic_score_strong_lower: float = -0.88
    dynamic_bucket_change_deadband: float = 0.32
    ...
    dynamic_demand_pressure_neutral_ratio: float = 0.98
    ...
    dynamic_min_bucket_index_late: int = 2
    dynamic_late_window_min_bucket_index: int = 3
